...
> 🚀 Built with [Soft UI Dashboard Generator](https://appseed.us/generator/soft-ui-dashboard/), timestamp `2022-07-01 15:36`
...
```bash
$ # Get the code
$ git clone https://github.com/appseed-projects/3246a0a0-53f0-49f0-bb8b-63b028378d8b.git
$ cd 3246a0a0-53f0-49f0-bb8b-63b028378d8b
```
